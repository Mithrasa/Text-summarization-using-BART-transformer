...
def index():
    if request.method == 'GET':
        ...
        inputs = tokenizer([text], max_length=10000, return_tensors='pt')
        summary_ids = model.generate(inputs['input_ids'], num_beams=4, max_length=1000, min_length=300, early_stopping=True)
